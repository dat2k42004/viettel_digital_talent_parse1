...
export const QUYEN = {
  ...
  XEM_NHAT_KY_THAO_TAC: 'XEM_NHAT_KY_THAO_TAC',
  ...
  // Quyền Kế hoạch bảo trì
  NHOM_KE_HOACH_BAO_TRI: 'NHOM_KE_HOACH_BAO_TRI',
  XEM_DANH_SACH_KHBTDK: 'XEM_DANH_SACH_KHBTDK',
  THEM_MOI_KHBTDK: 'THEM_MOI_KHBTDK',
  CAP_NHAT_KHBTDK: 'CAP_NHAT_KHBTDK',
  XOA_KHBTDK: 'XOA_KHBTDK',
  GUI_PHE_DUYET_KHBTDK: 'GUI_PHE_DUYET_KHBTDK',
  PHE_DUYET_KHBTDK: 'PHE_DUYET_KHBTDK',
  XEM_CHI_TIET_KHBTDK: 'XEM_CHI_TIET_KHBTDK',

  // Quyền Phiếu sửa chữa
  NHOM_PHIEU_SUA_CHUA: 'NHOM_PHIEU_SUA_CHUA',
  XEM_DANH_SACH_PHIEU_SUA_CHUA_BAO_TRI: 'XEM_DANH_SACH_PHIEU_SUA_CHUA_BAO_TRI',
  THEM_MOI_PHIEU_SUA_CHUA_BAO_TRI: 'THEM_MOI_PHIEU_SUA_CHUA_BAO_TRI',
  CAP_NHAT_PHIEU_SUA_CHUA_BAO_TRI: 'CAP_NHAT_PHIEU_SUA_CHUA_BAO_TRI',
  XOA_PHIEU_SUA_CHUA_BAO_TRI: 'XOA_PHIEU_SUA_CHUA_BAO_TRI',
  GUI_PHE_DUYET_PHIEU_SUA_CHUA_BAO_TRI: 'GUI_PHE_DUYET_PHIEU_SUA_CHUA_BAO_TRI',
  PHE_DUYET_PHIEU_SUA_CHUA_BAO_TRI: 'PHE_DUYET_PHIEU_SUA_CHUA_BAO_TRI',
  XEM_CHI_TIET_PHIEU_SUA_CHUA_BAO_TRI: 'XEM_CHI_TIET_PHIEU_SUA_CHUA_BAO_TRI',
  CAP_NHAT_TIEN_DO_PSCBT: 'CAP_NHAT_TIEN_DO_PSCBT',

  // Quyen Dot kiem ke (suffix DKK theo backend)
  NHOM_DOT_KIEM_KE: 'NHOM_DOT_KIEM_KE',
  XEM_DANH_SACH_DKK: 'XEM_DANH_SACH_DKK',
  XEM_CHI_TIET_DKK: 'XEM_CHI_TIET_DKK',
  THEM_MOI_DKK: 'THEM_MOI_DKK',
  CAP_NHAT_DKK: 'CAP_NHAT_DKK',
  XOA_DKK: 'XOA_DKK',
  GUI_PHE_DUYET_DKK: 'GUI_PHE_DUYET_DKK',
  PHE_DUYET_DKK: 'PHE_DUYET_DKK',

  // Quyen Phieu kiem ke (theo backend)
  NHOM_PHIEU_KIEM_KE: 'NHOM_PHIEU_KIEM_KE',
  XEM_DANH_SACH_PHIEU_KIEM_KE: 'XEM_DANH_SACH_PHIEU_KIEM_KE',
  XEM_CHI_TIET_PHIEU_KIEM_KE: 'XEM_CHI_TIET_PHIEU_KIEM_KE',
  THEM_MOI_PHIEU_KIEM_KE: 'THEM_MOI_PHIEU_KIEM_KE',
  CAP_NHAT_PHIEU_KIEM_KE: 'CAP_NHAT_PHIEU_KIEM_KE',
  XOA_PHIEU_KIEM_KE: 'XOA_PHIEU_KIEM_KE',
  THUC_HIEN_KIEM_KE_TAI_SAN: 'THUC_HIEN_KIEM_KE_TAI_SAN',
  XAC_NHAN_KET_QUA_KIEM_KE_PHONG_BAN: 'XAC_NHAN_KET_QUA_KIEM_KE_PHONG_BAN',
  XEM_TIEN_DO_KIEM_KE_DON_VI: 'XEM_TIEN_DO_KIEM_KE_DON_VI',
} as const;
